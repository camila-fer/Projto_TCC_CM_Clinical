				...
				<div class="row">
					<div class="col-md-4 col-sm-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="crm" name="crm" placeholder="Insira o CRM" required value="<?php echo @$crm ?>">
						</div>
					</div>
					<div class="col-md-4 col-sm-12">
						<div class="form-group">
					...
					<label for="exampleFormControlSelect1">Turno</label>
						<select class="form-control" id="" name="turno">
						 ...
						 ?>
						 	...
						 	<?php if($turno != 'Noite') echo '<option value="Noite">Noite</option>'; ?>
