        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item <?php echo @$item2ativo ?>" href="index.php?acao=<?php echo $item2 ?>">Médico</a>
                        <a class="collapse-item <?php echo @$item12ativo ?>" href="index.php?acao=<?php echo $item12 ?>">Horários</a>
                        <a class="collapse-item <?php echo @$item3ativo ?>" href="index.php?acao=<?php echo $item3 ?>">Funcionários</a>
                        <a class="collapse-item <?php echo @$item13ativo ?>" href="index.php?acao=<?php echo $item13 ?>">Pacientes</a>
                        <a class="collapse-item <?php echo @$item4ativo ?>" href="index.php?acao=<?php echo $item4 ?>">Usuários</a>
                        <a class="collapse-item <?php echo @$item5ativo ?>" href="index.php?acao=<?php echo $item5 ?>">Especializações</a>
                        <a class="collapse-item <?php echo $item6ativo ?>" href="index.php?acao=<?php echo $item6 ?>">Recepcionistas</a>
                        <a class="collapse-item <?php echo $item7ativo ?>" href="index.php?acao=<?php echo $item7 ?>">Atendimentos</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Cadastro:</h6>
                        <a class="collapse-item <?php echo @$item8ativo ?>" href="index.php?acao=<?php echo $item8 ?>">Agendamento</a>
                        <a class="collapse-item <?php echo @$item9ativo ?>" href="index.php?acao=<?php echo $item9 ?>">Dar baixa</a>
                        <a class="collapse-item <?php echo @$item10ativo ?>" href="index.php?acao=<?php echo $item10 ?>">Triagem</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Administrador - <?php echo $_SESSION['nome_usuario']; ?></span>
