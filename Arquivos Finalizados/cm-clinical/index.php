...
<body>
	...
	<div class="login-form">
		<form action="autenticar.php" method="post" style="background-color: white;">
			<div class="logo">
				<img src="img/logo-pag.png" alt="CM Clinical">
			</div>
			...
			<div class="form-group">
				<button class="btn btn-info btn-block">Entrar</button> <!--Botão-->
			</div>
...
if(isset($_POST['recuperar-senha'])){
	...
	$to = "camilafernandesdasilva4@gmail.com";
	$subject = 'Recuperação de Senha CM Clinical';
	...
	$headers .= "From: <camilafernandesdasilva4@gmail.com>";
