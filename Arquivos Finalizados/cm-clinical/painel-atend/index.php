            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item <?php echo @$item2ativo ?>" href="index.php?acao=<?php echo $item2 ?>">Cadastro de Paciente</a>

                        <a class="collapse-item <?php echo @$item5ativo ?>" href="index.php?acao=<?php echo $item5 ?>">Triagem</a>

                        <a class="collapse-item <?php echo @$item3ativo ?>" href="index.php?acao=<?php echo $item3 ?>">Consultas</a>

                        <a class="collapse-item <?php echo @$item4ativo ?>" href="index.php?acao=<?php echo $item4 ?>">Agendamento</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item <?php echo @$item6ativo ?>" href="index.php?acao=<?php echo $item6 ?>">Baixa de Consultas</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Recepcionista - <?php echo $_SESSION['nome_usuario']; ?></span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="" data-toggle="modal" data-target="#logoutModal">
                                    <i class="far fa-user-edit text-gray-400"></i>
                                    Sair
                                </a>
