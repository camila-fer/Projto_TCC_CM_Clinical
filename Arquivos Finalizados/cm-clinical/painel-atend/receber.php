		...
		<div class="modal-body">
			...
			<form method="post">
						...
						<div class="form-group">
							...
							<input type="hidden" id="id_consulta"  name="id_consulta" value="<?php echo @$id_consulta ?>" required>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="tipo" placeholder="Descreva o Tipo de Pagamento " name="tipo"  required>
						</div>
