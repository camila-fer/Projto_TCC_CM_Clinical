...
$res = $pdo->query("SELECT * from triagens where id = '$id_triagem'");
$dados = $res->fetchAll(PDO::FETCH_ASSOC);
$obs_triagem = $dados[0]['obs'];
$data = $dados[0]['data'];
$hora = $dados[0]['hora'];
...
<div class="container">
		...
		<table class="table">
			<tr bgcolor="#f9f9f9">
				<td style="font-size:12px"> <b>Urgência: <?php echo $urgencia ?> - <?php echo $data ?> - <?php echo $hora ?></b> </td>
                ...
                <tr>
				<td style="font-size:12px"> <?php echo $obs_triagem; ?> </td>
